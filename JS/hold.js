...
<div class="carder">
              ...
              <div id="message_${data[i].otp}" class="mess"></div>
              <div class="buttons">
              <button onclick="startevent('${data[i].otp}','message_${data[i].otp}')"; style="color:white;background-color: #2F54EB;">Start event</button>
              </div>
          </div>
`
      };
